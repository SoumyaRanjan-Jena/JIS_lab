//app/dashboard/view-cases/[CIN]/page.js
import React from "react";
import { headers } from 'next/headers';
import ViewLogger from '@/app/Components/ViewLogger';
...
export default async function Page({ params }) {
  ...
  const res = await fetch(`${protocol}://${host}/api/view-cases?type=0&data=${CIN}`);
    ...
    <div className="bg-white max-w-7xl mx-auto px-4 mb-6 mt-6">
      ...
      <div className="flex h-16 items-center">
        ...
        <div className="flex items-center gap-4">
          <span className={`px-3 py-1 rounded-full text-sm font-semibold ${caseData.caseStatus === 'Upcoming'
